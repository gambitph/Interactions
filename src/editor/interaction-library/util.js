 ...
 *
 * Gutenberg insert mode receives a block tree, so we resolve either the legacy
 * `blockPath` or the new semantic `targetRef` into a block and then convert it
 * into a standard Interactions target object.
 *
