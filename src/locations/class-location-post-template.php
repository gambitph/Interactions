...
if ( ! class_exists( 'Interact_Location_Post_Template' ) ) {
	class Interact_Location_Post_Template extends Interact_Location {

		public function initialize() {
			$this->name = 'post_template';
			$this->label = __( 'Post template', 'interactions' );
			$this->category = 'post';
		}
	...
	interact_add_location_rule_type( 'post_template', 'Interact_Location_Post_Template' );
}
