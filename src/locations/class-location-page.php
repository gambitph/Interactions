...
if ( ! class_exists( 'Interact_Location_Page' ) ) {
	class Interact_Location_Page extends Interact_Location {

		public function initialize() {
			$this->name = 'page';
			$this->label = __( 'Page', 'interactions' );
			$this->category = 'page';
		}
		...
		public function get_values() {
			...
			array_unshift( $posts, ( object ) [
				...
				'post_title' => sprintf( __( 'All %s', 'interactions' ), __( 'Pages', 'interactions' ) ),
			] );

			$options[] = [
				'label' => __( 'Page', 'interactions' ),
				'post_type' => 'page',
	...
	interact_add_location_rule_type( 'page', 'Interact_Location_Page' );
}
